...
function analysis() {
  ...
  deight = "Concentration infra-therapeutique au vu des resultats de bacteriologie (" + bactery + " dans nature prelevement du " + administrationdateday + "/" + administrationdatemonth + "/" + administrationdateyear + " a " + administrationtimehour + ":" + administrationtimemin + ", CMI = " + cmi + " mg/L) et selon les recommandations appliquees en reanimation (concentration libre > 4x CMI pendant 100% de l'interdose). Une adaptation de posologie est recommandee (par exemple XX mg/j) suivie d'un prelevement de controle 24 à 48h apres le changement de dose.";
